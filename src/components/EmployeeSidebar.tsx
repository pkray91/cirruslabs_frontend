...
const NAV_ITEMS = [
  { label: 'My Policies',    href: '/employee?tab=overview', icon: BookOpen       },
  { label: 'Ask GuardAI',    href: '/employee?tab=chat',     icon: MessageSquare  },
];
    ...
    >
      ...
      <nav style={{ flex: 1, padding: '8px 0', display: 'flex', flexDirection: 'column', gap: '2px' }}>
        {NAV_ITEMS.map(({ label, href, icon: Icon }) => {
          ...
          const targetTab = href.includes('tab=chat') ? 'chat' : 'overview';
          const isActive = pathname === '/employee' && currentTab === targetTab;
